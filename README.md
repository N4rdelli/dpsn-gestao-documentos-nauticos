<div align="center">
  ...
  <img src="dpsn-gestao-documentos-nauticos/imgs/Banner.png" alt="Banner DPSN">
...
| Assinatura Digital | Não Especificada |
...
> O projeto foi realizado em laboratórios da FATEC e computadores pessoais. A organização foi separada em tarefas para cada integrante.
...
<p align="center">
  <img src="dpsn-gestao-documentos-nauticos/imgs/Modelo%20de%20negocios.png" alt="Modelo de Negócio Canvas" width="1000">
</p>
...
<p align="center">
  <img src="dpsn-gestao-documentos-nauticos/imgs/Persona%201.png" alt="Persona 1" width="800">
</p>
...
<p align="center">
  <img src="dpsn-gestao-documentos-nauticos/imgs/Persona%202.png" alt="Persona 2" width="800">
</p>
...
A interface foi desenvolvida utilizando uma identidade visual corporativa baseada em tons de azul acinzentado (*Slate*), transmitindo profissionalismo, confiabilidade e organização. Cores secundárias são utilizadas para destacar estados de sucesso, alertas e notificações.

| Cor | Código Hex | Aplicação |
|------|------|------|
| ![](https://img.shields.io/badge/-%23020617-020617?style=for-the-badge) | `#020617` | Títulos principais |
| ![](https://img.shields.io/badge/-%230F172A-0F172A?style=for-the-badge) | `#0F172A` | Textos e informações importantes |
| ![](https://img.shields.io/badge/-%23334155-334155?style=for-the-badge) | `#334155` | Ícones e elementos secundários |
| ![](https://img.shields.io/badge/-%2364748B-64748B?style=for-the-badge) | `#64748B` | Textos auxiliares |
| ![](https://img.shields.io/badge/-%23F1F5F9-F1F5F9?style=for-the-badge) | `#F1F5F9` | Fundo de ícones e componentes |
| ![](https://img.shields.io/badge/-%23FFFFFF-FFFFFF?style=for-the-badge) | `#FFFFFF` | Fundo das páginas e cartões |
| ![](https://img.shields.io/badge/-%2310B981-10B981?style=for-the-badge) | `#10B981` | Indicadores de sucesso |
| ![](https://img.shields.io/badge/-%23047857-047857?style=for-the-badge) | `#047857` | Textos de status positivo |
| ![](https://img.shields.io/badge/-%23E11D48-E11D48?style=for-the-badge) | `#E11D48` | Alertas e pendências |
| ![](https://img.shields.io/badge/-%23D1D5DB-D1D5DB?style=for-the-badge) | `#D1D5DB` | Bordas dos componentes |

### 7.2 Tipografia

A aplicação utiliza a fonte **Poppins**, escolhida por sua legibilidade, aparência moderna e excelente adaptação a interfaces web corporativas.

| Fonte | Uso |
|-------|-----|
| Poppins Bold | Títulos e indicadores principais |
| Poppins SemiBold | Subtítulos e cabeçalhos |
| Poppins Regular | Textos gerais |
| Poppins Medium | Botões e formulários |
...
<p align="center">
  <img src="dpsn-gestao-documentos-nauticos/imgs/Logo.png" alt="Logo DPSN" width="300">
  <img src="dpsn-gestao-documentos-nauticos/imgs/logobranca.png" alt="Logo DPSN Branca" width="300">
</p>

A identidade visual da DPSN representa profissionalismo, confiabilidade e organização no gerenciamento de documentos náuticos, reforçando sua atuação no setor naval e sua proposta de modernização dos processos de documentação.
...
O sistema deve utilizar MongoDB para guardar os dados e armazenar os documentos gerados.
...
A escrita dos logs deve ser feita de forma assíncrona para não impactar o tempo de resposta da transação principal.
...
### 10.2 Diagrama do Banco de Dados

> *Figura 9 — Diagrama do Banco de Dados*

<p align="center">
  <img src="dpsn-gestao-documentos-nauticos/imgs/Diagrama%20Banco%20de%20dados.png" alt="Diagrama Banco de Dados" width="1100">
</p>
...
<p align="center">
  <img src="dpsn-gestao-documentos-nauticos/imgs/P%C3%A1gina%20de%20login.png" alt="Tela de Login" width="1100">
</p>

A tela de login permite a autenticação segura de administradores, tecnólogos e estaleiros através de e-mail e senha.
...
<p align="center">
  <img src="dpsn-gestao-documentos-nauticos/imgs/Painel%20de%20Controle%20Administrador.png" alt="Dashboard Administrativo" width="1100">
</p>

O dashboard apresenta indicadores gerenciais, estatísticas e acesso rápido aos principais módulos do sistema.
